            ...
            <div id="content">
                ...
                <div class="row">
                    <div class="container-fluid mt-4">
                                        ...
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-sm" width="100%" cellspacing="0">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $q_low = mysqli_query($koneksi, "SELECT * FROM tb_barang_habis_pakai WHERE deleted_at is null AND stok <= '$ambang_batas' ORDER BY stok ASC LIMIT 5");
                                                        if (mysqli_num_rows($q_low) > 0):
                                                            while ($low = mysqli_fetch_assoc($q_low)):
                                                        ?>
                                                                <tr>
                                                                    <td><?= $low['nama_barang']; ?> <?php if ($low['merek_barang']): ?> (<?= $low['merek_barang']; ?>) <?php endif; ?></td>
                                                                    <td><?= $low['satuan']; ?></td>
                        ...
                        <?php elseif ($role == 'pimpinan' || $role == 'super admin') : ?>
                        ...
                        <?php elseif ($role == 'admin bmn'): ?>
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    ...
                                                    <p>Anda login sebagai <strong>Admin Aset Barang Milik Negara</strong>. Gunakan menu di samping untuk:</p>
                                                    <ul>
                                                        <li>Mengelola data peminjaman aset BMN pada instansi BPMP Provinsi Bali.</li>
                                                        <li>Mengelola data pengembalian aset BMN pada instansi BPMP Provinsi Bali.</li>
                                                        <li>Melihat laporan aset BMN terkini.</li>
                                                    </ul>
                                                </div>
                            ...
                            $q_my_total = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tb_peminjaman WHERE status='selesai' AND deleted_at IS NULL");
                            $my_total = mysqli_fetch_assoc($q_my_total)['total'];

                            $q_my_acc = mysqli_query($koneksi, "SELECT COUNT(*) as total FROM tb_peminjaman WHERE status='disetujui' AND deleted_at IS NULL");
                                ...
                                <div class="col-xl-6 col-md-6 mb-4">
                                    <div class="card border-left-success shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-success text-uppercase mb-1">Total Peminjaman Aktif</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $my_total; ?> Peminjaman</div>
                                                </div>
                                                <div class="col-auto"><i class="fas fa-clock fa-2x text-gray-300"></i></div>
                                                <?php if ($my_total > 0): ?>
                                                    <a href="<?= BASE_URL ?>input_peminjaman_barang" class="btn btn-sm btn-success mt-2 shadow-sm btn-block">Lihat Sekarang <i class="fas fa-arrow-right"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-xl-6 col-md-6 mb-4">
                                    <div class="card border-left-info shadow h-100 py-2">
                                        <div class="card-body">
                                            <div class="row no-gutters align-items-center">
                                                <div class="col mr-2">
                                                    <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Peminjaman Disetujui (Perlu Upload Berkas)</div>
                                                    <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $my_acc; ?> Peminjaman</div>
                                                </div>
                                                <div class="col-auto"><i class="fas fa-check-circle fa-2x text-gray-300"></i></div>
                                                <?php if ($my_acc > 0): ?>
                                                    <a href="<?= BASE_URL ?>input_peminjaman_barang" class="btn btn-sm btn-info mt-2 shadow-sm btn-block">Proses Sekarang <i class="fas fa-arrow-right"></i></a>
                                                <?php endif; ?>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card shadow mb-4 border-left-primary">
                                        ...
                                        <div class="card-body">
                                            <div class="row align-items-center">
                                                <div class="col-md-8">
                                                    <h4 class="font-weight-bold mb-3">(PESONA) Penata Usahaan Stok Opname</h4>
                                                    <p>Anda login sebagai <strong>Staff</strong>. Gunakan menu di samping untuk:</p>
                                                    <ul>
                                                        <li>Melihat daftar aset BMN Anda.</li>
                                                    ...
                                                    <a href="<?= BASE_URL ?>daftar_barang" class="btn btn-primary shadow-sm mt-3">
