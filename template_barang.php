...
fputcsv($output, array('BRG-001', 'Contoh Laptop ASUS', 'ASUS', 'Unit', '10', 'Laptop Admin'));
fputcsv($output, array('BRG-002', 'Contoh Kertas A4', 'Paperone', 'Rim', '50', 'Kertas Paperone 80gr'));
