            ...
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $no = 1;
                        // JOIN KE TB_USER UNTUK AMBIL NAMA
                                ...
                                <div class="modal-content">
                                    ...
                                    <form method="POST" enctype="multipart/form-data">
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <label>Merk</label>
                                                <input type="text" name="merk_barang" class="form-control" value="<?= $row['merk_barang']; ?>">
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label>Update Berita Acara</label><br>
            ...
            <form method="POST" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="kode_barang" class="form-control" placeholder="Contoh: INV-LAP-01">
                    </div>
                    <div class="form-group">
                        <label>Nama Barang</label>
                        <input type="text" name="nama_barang" class="form-control" required placeholder="Contoh: Laptop">
                    </div>
                    <div class="form-group">
                        <label>Merk</label>
                        <input type="text" name="merk_barang" class="form-control" placeholder="Contoh: Asus / Lenovo">
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                    ...
                    <div class="form-group">
                        <label>Keterangan / Lokasi</label>
                        <textarea name="keterangan" class="form-control" placeholder="Contoh: Di Ruang Rapat"></textarea>
                    </div>
                    <div class="form-group">
                        <label>Upload Berita Acara (PDF/Gambar)</label>
                        <input type="file" name="berkas" class="form-control-file">
                    </div>
                </div>
                <div class="modal-footer">
...
<script>
    $(document).ready(function() {
        ...
        // Inisialisasi Select2 untuk Semua Modal Edit
